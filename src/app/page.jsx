...
import logoCalbos from '@/images/logos/calbos.png'
import logoCasadopro from '@/images/logos/casadopro.png'
import logoVetsolu from '@/images/logos/vetsolutions.png'
import logoVetscan from '@/images/logos/vetscan.png'
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        <Image src={role.logo} alt="" className="w-8" unoptimized />
      </div>
    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          Veterinary student, founder and product manager enthusiast 
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/gus_s1?igsh=MXM1OTF2OTRscW9obw%3D%3D&utm_source=qr"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/gustavosena09/"
